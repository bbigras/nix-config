...
let
  ...
  actions = {
    ...
    cache = "actions/cache@cdf6c1fa76f9f475f3d7449005a359c84ca0f306"; # v5.0.3
    ...
    nothing-but-nix = "wimpysworld/nothing-but-nix@dd6ef566962bfa4656301706035da97ebbe90e9b"; # v9
