...
let
  common = rec {
    ...
    keybindings = lib.mkOptionDefault {
      ...
      "XF86AudioLowerVolume" = "exec --no-startup-id ${lib.getExe pkgs.ponymix} decrease 10";
      ...
      "XF86AudioRaiseVolume" = "exec --no-startup-id ${lib.getExe pkgs.ponymix} increase 10";
      "XF86MonBrightnessDown" = "exec --no-startup-id ${lib.getExe pkgs.brillo} -e -U 10";
      "XF86MonBrightnessUp" = "exec --no-startup-id ${lib.getExe pkgs.brillo} -e -A 10";
    };
