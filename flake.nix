{
  ...
  inputs = {
    ...
    nixpkgs_veilid.url = "github:nixos/nixpkgs?rev=3b4f21beac1472f26dfaee39e58020b8dfa11e78";
    ...
    home-manager = {
      url = "github:nix-community/home-manager?rev=de8463dd3ef259502b937fac37fadd6adc252bfe";
      inputs.nixpkgs.follows = "nixpkgs";
    };
